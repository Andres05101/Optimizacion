...
class Metodo_Grafico:
    ...
    def graficar_restricciones(self):
        # Crear un espacio para graficar
        fig, ax = plt.subplots()
        ...
        for restriccion in self.restricciones:
            ...
            if coef_x2 != 0:
                y = (constante - coef_x1 * x) / coef_x2
                ax.plot(x, y, label=f'{coef_x1}x1 + {coef_x2}x2 {signo} {constante}')
...
def resolver():
    ...
    # Actualizar la interfaz para mostrar el método, la función Z y las restricciones
